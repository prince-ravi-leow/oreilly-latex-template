...
\DeclareFixedFont{\chaptextfont}{T1}{phv}{bx}{n}{1.5cm}
\DeclareFixedFont{\textaut}{T1}{phv}{bx}{n}{0.8cm}

\addtokomafont{chapter}{\color{gray}\chaptextfont}
...
\usepackage{lipsum}
\providecommand{\minisec}[1]{\par\medskip\noindent\textbf{#1}\par\nobreak\smallskip}
%%%%%%%%%%%%%%%%%%%%
\usepackage{enumitem}
...
%%%%%%%%%%%%%%%%%%%%%% First Page
\title{\chaptextfont{Latex Template}}
\author{
